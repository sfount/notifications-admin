  ...
  Modules.TemplateFolderForm = function() {
    ...
    this.start = function(templateFolderForm) {
      ...
      this.states = [
        ...
        {key: 'move-to-new-folder', $el: this.$form.find('#move_to_new_folder_form'), cancellable: true, setFocus: this.getFocusRoutine('#move_to_new_folder_name', false), action: 'add to new folder'},
